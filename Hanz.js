...
creator = 'AbyFathir' // GAK USAH DI UBAH
recode = 'AbyFathir' // UBAH NAMA LU
...
reply(`Udah Terdaftar Yak Makasih Udah Daftar Di Database Bot 📂`)
...
┌─❑「 INFO DEVELOPER 」
│👤 Nama : AbyyFathir
│📃 Github : https://github.com/AbyFthr
│▶ Yutub : Abi TV
│💮 Ig : @abifathir__
└─❑
┌─❑「 INFO BOTZ 」
...
││冬 ◗ _𝙰𝚋𝚢𝙱𝚘𝚝𝚣么_
│└──────── 
│冬◗ My Owner : AbyFathir
└─━━━─── • ───━━━❋ཻུ۪۪⸙

║▌│█║▌│ █║▌│█│║▌║
║▌│█║▌│ █║▌│█│║▌║
      「 Bot WhatsApp 」`
Sendbutdocument(from, `${menu}`, "*𝙰𝚋𝚢𝙱𝚘𝚝𝚣么*",
...
{quoted:fdoc, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`©𝙰𝚋𝚢𝙱𝚘𝚝𝚣么`,body:`gtau mau isi apaan`,mediaType:"2",thumbnail:fakeimage,mediaUrl:`https://youtube.com/channel/UCbVQD4K_0Qdd2a7PZLCuHSw`}}})
break
case 'menucatalog':
            menunya = `${pushname}
...
"listMessage": {
"title": 'MENU MUSIK 🔊\nBY : 𝙰𝚋𝚢𝙱𝚘𝚝𝚣么',
"description": `▬▭▬▭▬▭▬▭▬▬▭▬▭▬\nSUBSCRIBE\https://youtube.com/channel/UCbVQD4K_0Qdd2a7PZLCuHSw\nSUBSCRIBE AND LIKE\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬`,
"buttonText": "MENU️",
"listType": "SINGLE_SELECT",
 "thumbnail": virgam,
"sections": [
...
│◦➛${prefix}play
└─────────────────冬`,
						"footerText": "*Maaf Bang Fitur Masih Sedikit*",
						"jpegThumbnail": fs.readFileSync(`./media/Bot.jpg`), 
						"buttons": [
							{
								"buttonId": "!command",
...
case 'ytmp3':
                    ...
                    caption = `Nih Bang`
                    Hanz.sendMessage(from, ini_buffer, image, { quoted: mek})
                    get_audio = await getBuffer(get_result.link)
                    Hanz.sendMessage(from, get_audio, audio, { mimetype: 'audio/mp4', filename: `${get_result.title}.mp3`, quoted: mek})
                    break
                    case 'ytmp4':
...
ini_txt = `${get_result.title} - ${get_result.size}`
ini_buffer = await getBuffer(get_result.thumbnail)
await Hanz.sendMessage(from, ini_buffer, image, { quoted: mek, caption: 'Ni'})
get_audio = await getBuffer(get_result.link)
await Hanz.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: mek, caption: 'Ni'})
break
case 'play':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Abi TV`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe Abi TV`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
Hanz.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Abi TV' })
fs.unlinkSync(ran)
})
break				
//~~~~~~~~~~~~~~~~~~~~~[TAG MENU]~~~~~~~~~~~~~~~~~~~~~//
...
◦➛YT https://youtube.com/channel/UCbVQD4K_0Qdd2a7PZLCuHSw
▬▭▬▭▬▭▬▭▬▬▭▬▭
${ngazap(prefix)}`,
...
GROUP 𝙰𝚋𝚢𝙱𝚘𝚝𝚣么
https://chat.whatsapp.com/FXD0SuXKD4B0USCykSn2RV
...
break
case 'yt':
reply('https://youtube.com/channel/UCbVQD4K_0Qdd2a7PZLCuHSw')
break
case 'info':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
teks =
...
members_id = []
anu =`
Hayoo Mau Ngapain Kmu Ke Fitur Ini Wokwok :v`
but = [
...
sendButton(from, `PULSA : 0${Noovo}`, faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Dana : 0895333717964
❍┤ヅ Pulsa : 085709905866
❍┤ヅSaweria : -
    ╰───────────────❏`
gam = fs.readFileSync('./media/thumnail.jpg')
but = [
...
setTimeout( () => {
Hanz.sendMessage(from, ngebuff, image, { caption: '_Tebak bro!!! gak bisa jawab wajib subrek Abi TV :v_', quoted: ftrol }) 
}, 0) // 1000 = 1s,
break
//━━━━━━━━━━━━━━━[ AKHIR SEMUA FITUR ]━━━━━━━━━━━━━━━━━//
